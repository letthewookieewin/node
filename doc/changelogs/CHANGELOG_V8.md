...
* [[`58306b5c21`](https://github.com/nodejs/node/commit/58306b5c21)] - **build**: call setlocal in vcbuild.bat (Daniel Bevenius) [#15754](https://github.com/nodejs/node/pull/15754)
...
* [[`14f38fecb4`](https://github.com/nodejs/node/commit/14f38fecb4)] - **deps**: upgrade libuv to 1.15.0 (cjihrig) [#15745](https://github.com/nodejs/node/pull/15745)
* [[`4242c00f6d`](https://github.com/nodejs/node/commit/4242c00f6d)] - **deps**: cherry-pick f4a2b7f3 from V8 upstream. (Erin Spiceland) [#16053](https://github.com/nodejs/node/pull/16053)
...
* [[`b9866f01eb`](https://github.com/nodejs/node/commit/b9866f01eb)] - **doc**: fix http2 API docs typos (Daniela Borges Matos de Carvalho) [#15778](https://github.com/nodejs/node/pull/15778)
* [[`6d975eaf1e`](https://github.com/nodejs/node/commit/6d975eaf1e)] - **doc**: fix: correctly use `public key` instead of `private key` (Pavel Pomerantsev) [#16038](https://github.com/nodejs/node/pull/16038)
* [[`96030bb0f1`](https://github.com/nodejs/node/commit/96030bb0f1)] - **doc**: fix incorrect vm.createContext usage (tshemsedinov) [#16059](https://github.com/nodejs/node/pull/16059)
* [[`fe10dc7bba`](https://github.com/nodejs/node/commit/fe10dc7bba)] - **doc**: fix YAML syntax in fs.md (Luigi Pinca) [#15769](https://github.com/nodejs/node/pull/15769)
* [[`7c53f5d82e`](https://github.com/nodejs/node/commit/7c53f5d82e)] - **doc**: explain common.restore* functions (Rich Trott) [#15720](https://github.com/nodejs/node/pull/15720)
...
* [[`dec383aa51`](https://github.com/nodejs/node/commit/dec383aa51)] - **doc,test**: minor improvements to O_DSYNC (Tobias Nießen) [#15547](https://github.com/nodejs/node/pull/15547)
* [[`8ec81a80fa`](https://github.com/nodejs/node/commit/8ec81a80fa)] - **(SEMVER-MINOR)** **fs**: add O_DSYNC (Jussi Räsänen) [#15451](https://github.com/nodejs/node/pull/15451)
...
* [[`9a98731dab`](https://github.com/nodejs/node/commit/9a98731dab)] - **http2**: near full http1 compatibility, add tests (Anatoli Papirovski) [#15702](https://github.com/nodejs/node/pull/15702)
...
* [[`b6cec62761`](https://github.com/nodejs/node/commit/b6cec62761)] - **src**: fix ^ in stack trace with vm's columnOffset (Timothy Gu) [#15771](https://github.com/nodejs/node/pull/15771)
* [[`f889e98ca2`](https://github.com/nodejs/node/commit/f889e98ca2)] - **src**: remove unused node_dtrace.h from node_win32 (Daniel Bevenius) [#15768](https://github.com/nodejs/node/pull/15768)
* [[`a66515dcca`](https://github.com/nodejs/node/commit/a66515dcca)] - **src**: trace_event macro line continuation cleanup (Daniel Bevenius) [#15750](https://github.com/nodejs/node/pull/15750)
...
* [[`2ea3f70e09`](https://github.com/nodejs/node/commit/2ea3f70e09)] - **test**: add common.fixtures to https-req-split (Bruce Fletcher) [#15801](https://github.com/nodejs/node/pull/15801)
* [[`9d2cf15312`](https://github.com/nodejs/node/commit/9d2cf15312)] - **test**: http2 stored settings returned when present (Trivikram Kamat) [#15751](https://github.com/nodejs/node/pull/15751)
* [[`c940840a00`](https://github.com/nodejs/node/commit/c940840a00)] - **test**: fix flaky async-hooks/test-tlswrap (Rich Trott) [#15744](https://github.com/nodejs/node/pull/15744)
* [[`012998019d`](https://github.com/nodejs/node/commit/012998019d)] - **test**: remove `common.PORT` from test-tlswrap (Rich Trott) [#15742](https://github.com/nodejs/node/pull/15742)
* [[`6ef33fb63a`](https://github.com/nodejs/node/commit/6ef33fb63a)] - **test**: refactor test-internal-errors (Rich Trott) [#15721](https://github.com/nodejs/node/pull/15721)
* [[`1a0211a08f`](https://github.com/nodejs/node/commit/1a0211a08f)] - **test**: skip test if host is too slow (Rich Trott) [#15688](https://github.com/nodejs/node/pull/15688)
* [[`27c4efd712`](https://github.com/nodejs/node/commit/27c4efd712)] - **test**: mark test-bindings and test-debug-end flaky (João Reis) [#15747](https://github.com/nodejs/node/pull/15747)
...
* [[`5268414f47`](https://github.com/nodejs/node/commit/5268414f47)] - **util**: use faster -0 check (Brian White) [#15726](https://github.com/nodejs/node/pull/15726)
